<?php
/*
Plugin Name: WP e-Commerce - Clockwork SMS
Plugin URI: http://www.clockworksms.com/
Description: Send SMS notifications to your WP e-Commerce customers when order statuses change, send yourself an SMS when you get a new order.
Version: 2.4.3
